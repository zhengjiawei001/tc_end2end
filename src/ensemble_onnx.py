...
def infer(query_a, query_b):
    ...
    # bert2_logits = bert2.run(None, inputs)[0]
    # logits = np.concatenate([nezha1_logits, nezha2_logits,
    #                          bert1_logits, bert2_logits], axis=0)
    prob = softmax(nezha1_logits)
    return prob
...
if __name__ == '__main__':
    nezha1_path = './user_data/nezha-results-0.onnx'
    # nezha2_path = './user_data/nezha-2.onnx'
    # bert1_path = './user_data/bert-1.onnx'
    # bert2_path = './user_data/bert-2.onnx'
